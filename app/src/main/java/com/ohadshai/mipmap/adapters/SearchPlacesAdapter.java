...
import static com.ohadshai.mipmap.R.id.imgPlace;
import static com.ohadshai.mipmap.R.id.layoutSelect;

/**
 * Represents an adapter for the search places list.
...
public class SearchPlacesAdapter extends RecyclerView.Adapter<SearchPlacesAdapter.ViewHolder> {
    ...
    /**
     * C'tor
     * Initializes a new instance of an adapter for the search places list.
     *
     * @param places   The list of places to adapt.
     * @param activity The activity owner of the adapter.
     */
    public SearchPlacesAdapter(ArrayList<Place> places, Activity activity) {
        this._places = places;
    ...
    @Override
    public void onBindViewHolder(SearchPlacesAdapter.ViewHolder viewHolder, int position) {
        viewHolder.bindViewHolder(_places.get(position)); // Gets the place by the position, and binds it to the view holder.
    }

    @Override
    public void onViewRecycled(SearchPlacesAdapter.ViewHolder holder) {
    ...
    /**
     * Sets the activity owner.
     *
     * @param activity The activity owner to set.
     */
        ...
        ViewHolder(final View itemView) {
            ...
            _cardPlace.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    displayIntent.putExtra(UIConsts.Intent.GOOGLE_PLACE_ID_KEY, _place.getGooglePlaceId());
            ...
            _cardPlace.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    if (_selectionMode == null || !_selectionMode.isInSelectionMode()) {
                        ...
                        _selectionMode = SearchHelper.with((AppCompatActivity) _activity).enterSelectionMode(SearchPlacesAdapter.this);
            ...
            _imgPlace = (ImageView) itemView.findViewById(imgPlace);
        ...
        void bindViewHolder(Place place) {
            ...
            if (place.getPhotoReference() != null) {
                ...
                if (imgFile.exists()) {
                    ...
                    Picasso.with(_activity.getApplicationContext()).load(GooglePlacesConsts.Urls.GET_PHOTO_BY_REFERENCE + place.getPhotoReference())
                            .placeholder(R.drawable.no_place_image)
                            .fit()
                            .centerCrop()
                            .into(_imgPlace);
            ...
            if (place.getIcon() != null) {
                ...
                if (iconFile.exists())
                    Picasso.with(_activity.getApplicationContext()).load(iconFile).placeholder(R.drawable.no_place_type_icon).placeholder(R.drawable.no_place_type_icon).into(_imgPlaceIcon);
                else
